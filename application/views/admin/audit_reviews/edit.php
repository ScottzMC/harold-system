...
<?php foreach($audit_reviews as $audit){} ?>
<title>Edit <?php echo $audit->title; ?> Audit Reviews || Admin || Harold</title>
            ...
            <div class="container-fluid">
                <div class="d-flex justify-content-between align-items-center">
                    <div class="header-action">
                        <h1 class="page-title">Audit Reviews</h1>
                        <ol class="breadcrumb page-breadcrumb">
                            <li class="breadcrumb-item"><a href="<?php echo site_url('dashboard'); ?>">Dashboard</a></li>
                            <li class="breadcrumb-item"><a href="<?php echo site_url('audit_reviews'); ?>">Audit Reviews</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Edit Audit <?php echo $audit->title; ?> Reviews</li>
                        </ol>
                    </div>

                    <ul class="nav nav-tabs page-header-tab">
                        <li class="nav-item"><a class="nav-link active show" data-toggle="tab" href="#Audit-edit">Edit Audit <?php echo $audit->title; ?> Reviews</a></li>
        ...
        <div class="section-body mt-4">
            <div class="container-fluid">
                <div class="tab-content">
                    ...
                    <div class="tab-pane active" id="Audit-edit">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Edit Audit <?php echo $audit->title; ?> Reviews</h3>
                            </div>
                            <div class="card-body">
                                <form action="<?php echo base_url('audit_reviews/edit_audit_reviews/'.$audit->id); ?>" method="post" enctype="multipart/form-data" accept-charset="UTF-8">
                                    <div class="row">
                                        <div class="col-md-4 col-sm-12">
                                            <div class="form-group">
                                                <label>Title <span class="text-danger">*</span></label>
                                                <input type="text" name="title" class="form-control" value="<?php echo $audit->title; ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                <label>Body</label>
                                                <textarea name="body" class="form-control" aria-label="With textarea"><?php echo $audit->body; ?></textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-4 col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="performed_by" class="form-control" value="<?php echo $audit->performed_by; ?>">
                                            </div>
                                        </div>
