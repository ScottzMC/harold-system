...
<title>Audits Reviews || Admin || Harold</title>
            ...
            <div class="container-fluid">
                <div class="d-flex justify-content-between align-items-center">
                    <div class="header-action">
                        <h1 class="page-title">Audits Reviews</h1>
                        <ol class="breadcrumb page-breadcrumb">
                          <li class="breadcrumb-item"><a href="<?php echo site_url('dashboard'); ?>">Dashboard</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Audits Reviews</li>
                        </ol>
                    </div>

                    <ul class="nav nav-tabs page-header-tab">
                        <li class="nav-item"><a class="nav-link active show" data-toggle="tab" href="#Audits-all">View All Audits Reviews</a></li>
                        <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#Audits-add">Add Audits Reviews</a></li>
                    </ul>
                </div>
            </div>
        </div>
        <div class="section-body mt-4">
            <div class="container-fluid">
                <div class="tab-content">
                    ...
                    <!-- Audits Reviews -->
                    <div class="tab-pane active" id="Audits-all">
                        <script>
                        function delete_audit_reviews(id){
                          var del_id = id;
                          if(confirm("Are you sure you want to delete this audits reviews")){
                          $.post('<?php echo base_url('audit_reviews/delete_audit_reviews'); ?>', {"del_id": del_id}, function(data){
                        ...
                        <div class="table-responsive">
                          <table class="table table-hover table-vcenter text-nowrap js-basic-example dataTable table-striped table_custom border-style spacing5">
                                ...
                                <tbody>
                                  <?php if($audit_reviews){ foreach($audit_reviews as $audit){ ?>
                                    <tr>
                                        <td><?php echo $audit->id; ?></td>
                                        <td><span class="font-16"><?php echo $audit->title; ?></span></td>
                                        <td><?php echo $audit->body; ?></td>
                                        <td><?php echo $audit->performed_by; ?></td>
                                        <td><?php echo date('l, dS M Y',strtotime($audit->created_date)); ?></td>
                                        <td><a href="<?php echo site_url('audit_reviews/edit_audit_reviews/'.$audit->id); ?>">Edit</a></td>
                                        <td><button type="button" onclick="delete_audit_reviews(<?php echo $audit->id; ?>)">Delete</button></td>
                                    </tr>
                                  <?php } }else{ echo ''; } ?>
                                </tbody>
                            </table>
                    ...
                    <div class="tab-pane show" id="Audits-add">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Add Audit Reviews</h3>
                            </div>
                            <div class="card-body">
                                <form action="<?php echo base_url('audit_reviews/add_audit_reviews'); ?>" method="post" enctype="multipart/form-data" accept-charset="UTF-8">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 col-sm-12">
                                            <div class="form-group">
                                                <label>Performed by <span class="text-danger">*</span></label>
                                                <input type="text" name="performed_by" class="form-control" value="">
                                            </div>
                                        </div>
