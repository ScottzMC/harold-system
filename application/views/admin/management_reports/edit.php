...
<?php foreach($management_reports as $management){} ?>
<title>Edit <?php echo $management->title; ?> Management Reports || Admin || Harold</title>
                ...
                <div class="d-flex justify-content-between align-items-center">
                    <div class="header-action">
                        ...
                        <ol class="breadcrumb page-breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="<?php echo site_url('management_reports'); ?>">Management Reports </a></li>
                            <li class="breadcrumb-item active" aria-current="page">Edit <?php echo $management->title; ?> Management Reports</li>
                        </ol>
                    </div>

                    <ul class="nav nav-tabs page-header-tab">
                        <li class="nav-item"><a class="nav-link active show" data-toggle="tab" href="#Management-edit">Edit <?php echo $management->title; ?> Management Reports</a></li>
                    ...
                    <div class="tab-pane active" id="Management-edit">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Edit <?php echo $management->title; ?> Management Reports</h3>
                            </div>
                            <div class="card-body">
                                <form action="<?php echo base_url('management_reports/edit_management_reports/'.$management->id); ?>" method="post" enctype="multipart/form-data" accept-charset="UTF-8">
                                    <div class="row">
                                        <div class="col-md-4 col-sm-12">
                                            <div class="form-group">
                                                <label>Title <span class="text-danger">*</span></label>
                                                <input type="text" name="title" class="form-control" value="<?php echo $management->title; ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                <label>Body</label>
                                                <textarea name="body" class="form-control" aria-label="With textarea"><?php echo $management->body; ?></textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-4 col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="availabilty">
                                                    <option value="<?php echo $management->availabilty; ?>"><?php echo $management->availabilty; ?></option>
                                        ...
                                        <div class="col-md-4 col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <input type="date" name="staff_shift" class="form-control" value="" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-4 col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="repair_performed_by" class="form-control" value="<?php echo $management->repair_performed_by; ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-4 col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <input type="date" name="repair_date" class="form-control" value="" required>
                                            </div>
                                        </div>
