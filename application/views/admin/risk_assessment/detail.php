...
<title><?php echo $risk->title; ?> Risk Assessment || Admin || Harold</title>
            ...
            <div class="container-fluid">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <ul class="nav nav-tabs page-header-tab">
                        <li class="nav-item"><a class="nav-link active show" data-toggle="tab" href="#Risk-profile">Edit <?php echo $risk->title; ?> Risk Assessment</a></li>
        ...
        <div class="section-body mt-4">
            <div class="container-fluid">
                <div class="tab-content">
                    ...
                    <div class="tab-pane active" id="Risk-profile">
                        <div class="row">
                            <div class="col-xl-4 col-md-12">
                                <div class="card">
                                    <div class="card-body w_user">
                                        <div class="wid-u-info">
                                            <h5><?php echo $risk->title; ?></h5>
                                        </div>
                                    </div>
                                </div>
                                <div class="card">
									...
									<div class="card-body">
										<ul class="list-group">
                                            <li class="list-group-item">
                                                <b>Last Assessed </b>
                                                <div class="pull-right"><?php echo $risk->last_assessed; ?></div>
                                            </li>
                                            <li class="list-group-item">
                                                <b>Action </b>
                                                <div class="pull-right"><a href="<?php echo site_url('risk_assessment/edit_risk_assessment/'.$risk->id); ?>">Edit</a></div>
                                            </li>
                                            <li class="list-group-item">
                                                <b>Action </b>
                                                <div class="pull-right"><a href="<?php echo site_url('risk_assessment/download/'.$risk->id); ?>">Download</a></div>
                                            </li>
                                        </ul>
                                    </div>
