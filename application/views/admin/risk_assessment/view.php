...
<title>Risk Assessment || Admin || Harold</title>
            ...
            <div class="container-fluid">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <ul class="nav nav-tabs page-header-tab">
                        <li class="nav-item"><a class="nav-link active show" data-toggle="tab" href="#Risk-all">View All Risk Assessment</a></li>
                        <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#Risk-add">Add Risk Assessment</a></li>
                    </ul>
                </div>
            </div>
        </div>
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane active" id="Risk-all">
                        ...
                        function delete_risk_assessment(id){
                          ...
                          $.post('<?php echo base_url('risk_assessment/delete_risk_assessment'); ?>', {"del_id": del_id}, function(data){
                                ...
                                <tbody>
                                  <?php if($risk_assessment){ foreach($risk_assessment as $risk){ ?>
                                    <tr>
                                        ...
                                        <td><span class="font-16"><?php echo $risk->title; ?></span></td>
                                        <td><?php echo $risk->body; ?></td>
                                        <td><?php echo convertToRiskFormat($risk->created_time); ?></td>
                                        <td><?php echo date('l, dS M Y',strtotime($risk->last_assessed)); ?></td>
                                        <td><?php echo date('l, dS M Y',strtotime($risk->created_date)); ?></td>
                                        <td><a href="<?php echo site_url('risk_assessment/detail/'.$risk->id); ?>">View</a></td>
                                        <td><a href="<?php echo site_url('risk_assessment/edit_risk_assessment/'.$risk->id); ?>">Edit</a></td>
                    ...
                    <div class="tab-pane show" id="Risk-add">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Add Reminder</h3>
                            </div>
                            <div class="card-body">
                                <form action="<?php echo base_url('risk_assessment/add_risk_assessment'); ?>" method="post" enctype="multipart/form-data" accept-charset="UTF-8">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 col-sm-12">
                                            <div class="form-group">
                                                <label>Last Assessed date (set the date upon update) <span class="text-danger">*</span></label>
                                                <input type="date" name="last_assessed" class="form-control" required>
                                            </div>
                                        </div>
