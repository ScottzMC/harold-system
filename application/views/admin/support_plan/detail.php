...
<title><?php echo $support->title; ?> Support Plan || Admin || Harold</title>
                ...
                <div class="d-flex justify-content-between align-items-center">
                    <div class="header-action">
                        ...
                        <ol class="breadcrumb page-breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="<?php echo site_url('support_plan'); ?>">Support Plan </a></li>
                            <li class="breadcrumb-item active" aria-current="page">Edit <?php echo $support->title; ?> Support Plan</li>
                        </ol>
                    </div>

                    <ul class="nav nav-tabs page-header-tab">
                        <li class="nav-item"><a class="nav-link active show" data-toggle="tab" href="#Support-profile">Edit <?php echo $support->title; ?> Support Plan</a></li>
									...
									<div class="card-body">
										<ul class="list-group">
                                            <li class="list-group-item">
                                                <b>Action </b>
                                                <div class="pull-right"><a href="<?php echo site_url('support_plan/edit_support_plan/'.$support->id); ?>">Edit</a></div>
                                            </li>
                                            <li class="list-group-item">
                                                <b>Action </b>
                                                <div class="pull-right"><a href="<?php echo site_url('support_plan/download_file/'.$support->id); ?>">Download</a></div>
                                            </li>
                                        </ul>
                                    </div>
