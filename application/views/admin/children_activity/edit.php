...
<?php foreach($children_activity as $child){} ?>
<title>Edit <?php echo $child->firstname; ?> <?php echo $child->lastname; ?> Children's Activity || Admin || Harold</title>
            ...
            <div class="container-fluid">
                <div class="d-flex justify-content-between align-items-center">
                    <div class="header-action">
                        <h1 class="page-title">Children's Activity</h1>
                        <ol class="breadcrumb page-breadcrumb">
                            <li class="breadcrumb-item"><a href="<?php echo site_url('dashboard'); ?>">Dashboard</a></li>
                            <li class="breadcrumb-item"><a href="<?php echo site_url('children_activity'); ?>">Children's Activity</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Edit <?php echo $child->firstname; ?> <?php echo $child->lastname; ?></li>
                        </ol>
                    </div>

                    <ul class="nav nav-tabs page-header-tab">
                        <li class="nav-item"><a class="nav-link active show" data-toggle="tab" href="#Activity-edit">Edit Children's Activity</a></li>
        ...
        <div class="section-body mt-4">
            <div class="container-fluid">
                <div class="tab-content">
                    ...
                    <div class="tab-pane active" id="Activity-edit">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Edit <?php echo $child->firstname; ?> <?php echo $child->lastname; ?> Children's Activity</h3>
                            </div>
                            <div class="card-body">
                                <form action="<?php echo base_url('children_activity/edit_children_activity/'.$child->id); ?>" method="post" enctype="multipart/form-data" accept-charset="UTF-8">
                                    <div class="row">
                                        <div class="col-md-4 col-sm-12">
                                            <div class="form-group">
                                                <label>First Name <span class="text-danger">*</span></label>
                                                <input type="text" name="firstname" class="form-control" value="<?php echo $child->firstname; ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-4 col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="lastname" class="form-control" value="<?php echo $child->lastname; ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                <label>Body</label>
                                                <textarea name="body" class="form-control" aria-label="With textarea"><?php echo $child->body; ?></textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-4 col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="status">
                                                    <option value="<?php echo $child->status; ?>"><?php echo $child->status; ?></option>
                                        ...
                                        <div class="col-md-4 col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="hour_time">
                                                    <option value="<?php echo $child->hour_time; ?>"><?php echo $child->hour_time; ?></option>
                                                    <option>Select</option>
