...
<title>Children's Activity || Admin || Harold</title>
                    ...
                    <div class="header-action">
                        ...
                        <ol class="breadcrumb page-breadcrumb">
                          <li class="breadcrumb-item"><a href="<?php echo site_url('dashboard'); ?>">Dashboard</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Children's Activity</li>
                        </ol>
                    </div>

                    <ul class="nav nav-tabs page-header-tab">
                        <li class="nav-item"><a class="nav-link active show" data-toggle="tab" href="#Activity-all">View All Children's Activity</a></li>
                        <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#Activity-add">Add Children's Activity</a></li>
                    </ul>
                </div>
            </div>
        </div>
            ...
            <div class="container-fluid">
                <div class="tab-content">
                    ...
                    <div class="tab-pane active" id="Activity-all">
                        <script>
                        function delete_children_activity(id){
                          var del_id = id;
                          if(confirm("Are you sure you want to delete this activity")){
                          $.post('<?php echo base_url('reminder/delete_children_activity'); ?>', {"del_id": del_id}, function(data){
                        ...
                        <div class="table-responsive">
                          <table class="table table-hover table-vcenter text-nowrap js-basic-example dataTable table-striped table_custom border-style spacing5">
                                ...
                                <tbody>
                                  <?php if($children_activity){ foreach($children_activity as $child){ ?>
                                    <tr>
                                        <td><?php echo $child->id; ?></td>
                                        <td><span class="font-16"><?php echo $child->firstname; ?></span></td>
                                        <td><?php echo $child->lastname; ?></td>
                                        <td><?php echo $child->body; ?></td>
                                        <td><?php echo $child->status; ?></td>
                                        <td><?php echo $child->hour_time; ?></td>
                                        <td><?php echo date('l, dS M Y',strtotime($child->created_date)); ?></td>
                                        <td><a href="<?php echo site_url('children_activity/edit_children_activity/'.$child->id); ?>">Edit</a></td>
                                        <td><button type="button" onclick="delete_children_activity(<?php echo $child->id; ?>)">Delete</button></td>
                                    </tr>
                                  <?php } }else{ echo ''; } ?>
                                </tbody>
                            </table>
                    ...
                    <div class="tab-pane show" id="Activity-add">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Add Children's Activity</h3>
                            </div>
                            <div class="card-body">
                                <form action="<?php echo base_url('children_activity/add_children_activity'); ?>" method="post" enctype="multipart/form-data" accept-charset="UTF-8">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 col-sm-12">
                                            <div class="form-group">
                                                <label>Hour Time <span class="text-danger">*</span></label>
