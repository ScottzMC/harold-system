...
<title>Edit <?php echo $cal->title; ?> Calendar Events || Admin || Harold</title>
                ...
                <div class="d-flex justify-content-between align-items-center">
                    <div class="header-action">
                        ...
                        <ol class="breadcrumb page-breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="<?php echo site_url('calendar_event'); ?>">Calendar Events</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Edit Calendar <?php echo $cal->title; ?> Event</li>
                        </ol>
                    </div>

                    <ul class="nav nav-tabs page-header-tab">
                        <li class="nav-item"><a class="nav-link active show" data-toggle="tab" href="#Calendar-edit">Edit Calendar <?php echo $cal->title; ?> Events</a></li>
        ...
        <div class="section-body mt-4">
            <div class="container-fluid">
                <div class="tab-content">
                    ...
                    <div class="tab-pane active" id="Calendar-edit">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Edit Calendar <?php echo $cal->title; ?> Events</h3>
                            </div>
                            <div class="card-body">
                                <form action="<?php echo base_url('calendar_event/edit_event/'.$cal->id); ?>" method="post" enctype="multipart/form-data" accept-charset="UTF-8">
                                    <div class="row">
                                        <div class="col-md-4 col-sm-12">
                                            <div class="form-group">
                                                <label>Title <span class="text-danger">*</span></label>
                                                <input type="text" name="title" class="form-control" value="<?php echo $cal->title; ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                <label>Body</label>
                                                <textarea name="body" class="form-control" aria-label="With textarea"><?php echo $cal->body; ?></textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <textarea name="note" class="form-control" aria-label="With textarea"><?php echo $cal->note; ?></textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-4 col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="status">
                                                    <option value="<?php echo $cal->status; ?>"><?php echo $cal->status; ?></option>
                                        ...
                                        <div class="col-md-4 col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="category">
                                                    <option value="<?php echo $cal->category; ?>"><?php echo $cal->category; ?></option>
                                                    <option>Select</option>
                                        ...
                                        <div class="col-md-4 col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="event_time">
                                                    <option value="<?php echo $cal->event_time; ?>"><?php echo $cal->event_time; ?></option>
                                                    <option>Select</option>
