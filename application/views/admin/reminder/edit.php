...
<title>Edit <?php echo $rem->title; ?> Reminders || Admin || Harold</title>
                ...
                <div class="d-flex justify-content-between align-items-center">
                    <div class="header-action">
                        ...
                        <ol class="breadcrumb page-breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="<?php echo site_url('reminder'); ?>">Reminders</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Edit <?php echo $rem->title; ?> Reminder</li>
                        </ol>
                    </div>

                    <ul class="nav nav-tabs page-header-tab">
                        <li class="nav-item"><a class="nav-link active show" data-toggle="tab" href="#Reminder-edit">Edit <?php echo $rem->title; ?> Reminder</a></li>
        ...
        <div class="section-body mt-4">
            <div class="container-fluid">
                <div class="tab-content">
                    ...
                    <div class="tab-pane active" id="Reminder-edit">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Edit <?php echo $rem->title; ?> Reminder</h3>
                            </div>
                            <div class="card-body">
                                <form action="<?php echo base_url('reminder/edit_reminder/'.$rem->id); ?>" method="post" enctype="multipart/form-data" accept-charset="UTF-8">
                                    <div class="row">
                                        <div class="col-md-4 col-sm-12">
                                            <div class="form-group">
                                                <label>Title <span class="text-danger">*</span></label>
                                                <input type="text" name="title" class="form-control" value="<?php echo $rem->title; ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                <label>Body</label>
                                                <textarea name="body" class="form-control" aria-label="With textarea"><?php echo $rem->body; ?></textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-4 col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="status">
                                                    <option value="<?php echo $rem->status; ?>"><?php echo $rem->status; ?></option>
                                        ...
                                        <div class="col-md-4 col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="reminder_time">
                                                    <option value="<?php echo $rem->reminder_time; ?>"><?php echo $rem->reminder_time; ?></option>
                                                    <option>Select</option>
