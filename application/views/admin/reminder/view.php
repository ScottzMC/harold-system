...
<title>Reminders || Admin || Harold</title>
            ...
            <div class="container-fluid">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <ul class="nav nav-tabs page-header-tab">
                        <li class="nav-item"><a class="nav-link active show" data-toggle="tab" href="#Reminder-all">View All Reminders</a></li>
                        <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#Reminder-add">Add Reminders</a></li>
                    </ul>
                </div>
            </div>
        </div>
        <div class="section-body mt-4">
            <div class="container-fluid">
                <div class="tab-content">
                    ...
                    <!-- Calendar Events -->
                    <div class="tab-pane active" id="Reminder-all">
                        <script>
                        function delete_reminder(id){
                          var del_id = id;
                          if(confirm("Are you sure you want to delete this reminder")){
                          $.post('<?php echo base_url('reminder/delete_reminder'); ?>', {"del_id": del_id}, function(data){
                        ...
                        <div class="table-responsive">
                          <table class="table table-hover table-vcenter text-nowrap js-basic-example dataTable table-striped table_custom border-style spacing5">
                                ...
                                <tbody>
                                  <?php if($reminder){ foreach($reminder as $rem){ ?>
                                    <tr>
                                        <td><?php echo $rem->id; ?></td>
                                        <td><span class="font-16"><?php echo $rem->title; ?></span></td>
                                        <td><?php echo $rem->body; ?></td>
                                        <td><?php echo $rem->status; ?></td>
                                        <td><?php echo $rem->reminder_time; ?></td>
                                        <td><?php echo date('l, dS M Y',strtotime($rem->created_date)); ?></td>
                                        <td><a href="<?php echo site_url('reminder/edit_reminder/'.$rem->id); ?>">Edit</a></td>
                                        <td><button type="button" onclick="delete_reminder(<?php echo $rem->id; ?>)">Delete</button></td>
                                    </tr>
                                  <?php } }else{ echo ''; } ?>
                                </tbody>
                            </table>
                    ...
                    <div class="tab-pane show" id="Reminder-add">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Add Reminder</h3>
                            </div>
                            <div class="card-body">
                                <form action="<?php echo base_url('reminder/add_reminder'); ?>" method="post" enctype="multipart/form-data" accept-charset="UTF-8">
                                    <div class="row">
