...
<?php foreach($sanction_report as $sanction){} ?>
<title>Edit <?php echo $sanction->title; ?> Sanction Report || Admin || Harold</title>
                ...
                <div class="d-flex justify-content-between align-items-center">
                    <div class="header-action">
                        ...
                        <ol class="breadcrumb page-breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="<?php echo site_url('sanction_report'); ?>">Sanction Report </a></li>
                            <li class="breadcrumb-item active" aria-current="page">Edit <?php echo $sanction->title; ?> Sanction Report</li>
                        </ol>
                    </div>

                    <ul class="nav nav-tabs page-header-tab">
                        <li class="nav-item"><a class="nav-link active show" data-toggle="tab" href="#Sanction-edit">Edit <?php echo $sanction->title; ?> Sanction Report</a></li>
        ...
        <div class="section-body mt-4">
            <div class="container-fluid">
                <div class="tab-content">
                    <div class="tab-pane active" id="Sanction-edit">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Edit <?php echo $sanction->title; ?> Sanction Report</h3>
                            </div>
                            <div class="card-body">
                                <form action="<?php echo base_url('sanction_report/edit_sanction_report/'.$sanction->id); ?>" method="post" enctype="multipart/form-data" accept-charset="UTF-8">
                                    <div class="row">
                                        <div class="col-md-4 col-sm-12">
                                            <div class="form-group">
                                                <label>Title <span class="text-danger">*</span></label>
                                                <input type="text" name="title" class="form-control" value="<?php echo $sanction->title; ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                <label>Body</label>
                                                <textarea name="body" class="form-control" aria-label="With textarea"><?php echo $sanction->body; ?></textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-4 col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="house_name">
                                                    <option value="<?php echo $sanction->house_name; ?>"><?php echo $sanction->house_name; ?></option>
                                                    <option>Select</option>
                                        ...
                                        <div class="col-md-4 col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <input type="date" name="disciplinary_date" class="form-control" value="" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <textarea name="action_taken" class="form-control" aria-label="With textarea"><?php echo $sanction->action_taken; ?></textarea>
                                            </div>
                                        </div>
