...
<title>Properties || Admin || Harold</title>
            ...
            <div class="container-fluid">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <ul class="nav nav-tabs page-header-tab">
                        <li class="nav-item"><a class="nav-link active show" data-toggle="tab" href="#Properties-all">View All Properties</a></li>
                        <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#Properties-add">Add Properties</a></li>
                    </ul>
                </div>
            </div>
        </div>
        <div class="section-body mt-4">
            <div class="container-fluid">
                <div class="tab-content">
                    ...
                    <!-- Calendar Events -->
                    <div class="tab-pane active" id="Properties-all">
                        <script>
                        function delete_property(id){
                          var del_id = id;
                          if(confirm("Are you sure you want to delete this property")){
                          $.post('<?php echo base_url('property/delete_property'); ?>', {"del_id": del_id}, function(data){
                        ...
                        <div class="table-responsive">
                          <table class="table table-hover table-vcenter text-nowrap js-basic-example dataTable table-striped table_custom border-style spacing5">
                                ...
                                <tbody>
                                  <?php if($property){ foreach($property as $prop){ ?>
                                    <tr>
                                        <td><?php echo $prop->id; ?></td>
                                        <td><span class="font-16"><?php echo $prop->housename; ?></span></td>
                                        <td><?php echo $prop->body; ?></td>
                                        <td><?php echo $prop->category; ?></td>
                                        <td><?php echo $prop->telephone; ?></td>
                                        <td><?php echo $prop->mobile; ?></td>
                                        <td><?php echo $prop->address; ?></td>
                                        <td><?php echo $prop->postcode; ?></td>
                                        <td><?php echo $prop->city; ?></td>
                                        <td><?php echo $prop->state; ?></td>
                                        <td><?php echo date('l, dS M Y',strtotime($prop->created_date)); ?></td>
                                        <td><a href="<?php echo site_url('property/edit_property/'.$prop->id); ?>">Edit</a></td>
                                        <td><button type="button" onclick="delete_property(<?php echo $prop->id; ?>)">Delete</button></td>
                                    </tr>
                                  <?php } }else{ echo ''; } ?>
                                </tbody>
                            </table>
                    ...
                    <div class="tab-pane show" id="Properties-add">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Add Properties</h3>
                            </div>
                            <div class="card-body">
                                <form action="<?php echo base_url('property/add_property'); ?>" method="post" enctype="multipart/form-data" accept-charset="UTF-8">
                                    <div class="row">
                                        <div class="col-md-4 col-sm-12">
                                            <div class="form-group">
                                                <label>House Name <span class="text-danger">*</span></label>
                                                <input type="text" name="housename" class="form-control" value="">
                                            </div>
                                        </div>
