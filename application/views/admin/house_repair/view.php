...
<title>House repairs || Admin || Harold</title>
            ...
            <div class="container-fluid">
                <div class="d-flex justify-content-between align-items-center">
                    <div class="header-action">
                        <h1 class="page-title">House repairs</h1>
                        <ol class="breadcrumb page-breadcrumb">
                          <li class="breadcrumb-item"><a href="<?php echo site_url('dashboard'); ?>">Dashboard</a></li>
                            <li class="breadcrumb-item active" aria-current="page">House repairs</li>
                        </ol>
                    </div>

                    <ul class="nav nav-tabs page-header-tab">
                        <li class="nav-item"><a class="nav-link active show" data-toggle="tab" href="#House-all">View All House repairs</a></li>
                        <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#House-add">Add House repairs</a></li>
                    </ul>
                </div>
            </div>
        </div>
        <div class="section-body mt-4">
            <div class="container-fluid">
                <div class="tab-content">
                    ...
                    <!-- Calendar Events -->
                    <div class="tab-pane active" id="House-all">
                        <script>
                        function delete_house_repairs(id){
                          var del_id = id;
                          if(confirm("Are you sure you want to delete this house repairs")){
                          $.post('<?php echo base_url('house_repair/delete_house_repairs'); ?>', {"del_id": del_id}, function(data){
                          ...
                          <table class="table table-hover table-vcenter text-nowrap js-basic-example dataTable table-striped table_custom border-style spacing5">
                                <thead>
                                    <tr>
                                        ...
                                        <th>Status</th>
                                        <th>Repaired by</th>
                                        <th>Repaired by email</th>
                                        <th>Repaired by mobile number</th>
                                        <th>Repaired by address</th>
                                        <th>Time</th>
                                        <th>Date</th>
                                        <th>Action</th>
                                        <th>Action</th>
                                ...
                                <tbody>
                                  <?php if($house_repair){ foreach($house_repair as $house){ ?>
                                    <tr>
                                        <td><?php echo $house->id; ?></td>
                                        <td><span class="font-16"><?php echo $house->title; ?></span></td>
                                        <td><?php echo $house->body; ?></td>
                                        <td><?php echo $house->category; ?></td>
                                        <td><?php echo $house->status; ?></td>
                                        <td><?php echo $house->repair_fullname; ?></td>
                                        <td><?php echo $house->repair_email; ?></td>
                                        <td><?php echo $house->repair_mobile; ?></td>
                                        <td><?php echo $house->repair_address; ?></td>
                                        <td><?php echo $house->created_time; ?></td>
                                        <td><?php echo date('l, dS M Y',strtotime($house->created_date)); ?></td>
                                        <td><a href="<?php echo site_url('house_repairs/edit_house_repair/'.$house->id); ?>">Edit</a></td>
                                        <td><button type="button" onclick="delete_house_repairs(<?php echo $house->id; ?>)">Delete</button></td>
                                    </tr>
                                  <?php } }else{ echo ''; } ?>
                                </tbody>
                            </table>
                    ...
                    <div class="tab-pane show" id="House-add">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Add House repairs</h3>
                            </div>
                            <div class="card-body">
                                <form action="<?php echo base_url('house_repairs/add_house_repairs'); ?>" method="post" enctype="multipart/form-data" accept-charset="UTF-8">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="repair_fullname" class="form-control" value="">
                                            </div>
                                        </div>
                                        
                                        <div class="col-md-4 col-sm-12">
                                            <div class="form-group">
                                                <label>Repaired by email <span class="text-danger">*</span></label>
                                                <input type="text" name="repair_email" class="form-control" value="">
                                            </div>
                                        </div>
                                        
                                        <div class="col-md-4 col-sm-12">
                                            <div class="form-group">
                                                <label>Repaired by mobile number <span class="text-danger">*</span></label>
                                                <input type="text" name="repair_mobile" class="form-control" value="">
                                            </div>
                                        </div>
                                        
                                        <div class="col-md-4 col-sm-12">
                                            <div class="form-group">
                                                <label>Repaired by address <span class="text-danger">*</span></label>
                                                <input type="text" name="repair_address" class="form-control" value="">
                                            </div>
                                        </div>
