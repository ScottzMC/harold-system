...
<?php foreach($house_repair as $house){} ?>
<title>Edit <?php echo $house->title; ?> House repairs || Admin || Harold</title>
                ...
                <div class="d-flex justify-content-between align-items-center">
                    <div class="header-action">
                        ...
                        <ol class="breadcrumb page-breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="<?php echo site_url('house_repairs'); ?>">House Repairs</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Edit <?php echo $house->title; ?> House Repairs</li>
                        </ol>
                    </div>

                    <ul class="nav nav-tabs page-header-tab">
                        <li class="nav-item"><a class="nav-link active show" data-toggle="tab" href="#House-edit">Edit <?php echo $house->title; ?> House Repairs</a></li>
        ...
        <div class="section-body mt-4">
            <div class="container-fluid">
                <div class="tab-content">
                    ...
                    <div class="tab-pane active" id="House-edit">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Edit <?php echo $house->title; ?> House Repairs</h3>
                            </div>
                            <div class="card-body">
                                <form action="<?php echo base_url('house_repairs/edit_house_repair/'.$house->id); ?>" method="post" enctype="multipart/form-data" accept-charset="UTF-8">
                                    <div class="row">
                                        <div class="col-md-4 col-sm-12">
                                            <div class="form-group">
                                                <label>Title <span class="text-danger">*</span></label>
                                                <input type="text" name="title" class="form-control" value="<?php echo $house->title; ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                <label>Body</label>
                                                <textarea name="body" class="form-control" aria-label="With textarea"><?php echo $house->body; ?></textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-4 col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="category">
                                                    <option value="<?php echo $house->category; ?>"><?php echo $house->category; ?></option>
                                        ...
                                        <div class="col-md-4 col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="status">
                                                    <option value="<?php echo $house->status; ?>"><?php echo $house->status; ?></option>
                                                    <option>Select</option>
                                        ...
                                        <div class="col-md-4 col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="created_time">
                                                    <option value="<?php echo $house->created_time; ?>"><?php echo $house->created_time; ?></option>
                                                    <option>Select</option>
                                        ...
                                        <div class="col-md-4 col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="repair_fullname" class="form-control" value="<?php echo $house->repair_fullname; ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-4 col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="repair_email" class="form-control" value="<?php echo $house->repair_email; ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-4 col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="repair_mobile" class="form-control" value="<?php echo $house->repair_mobile; ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-4 col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="repair_address" class="form-control" value="<?php echo $house->repair_address; ?>">
                                            </div>
                                        </div>
