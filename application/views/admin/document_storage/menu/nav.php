        ...
        <div class="tab-pane fade show active" id="menu-admin" role="tabpanel">
            <nav class="sidebar-nav">
                <ul class="metismenu">
                    ...
                    <li><a href="<?php echo site_url('children_activity'); ?>"><i class="fa fa-book"></i><span>Children's Activity</span></a></li>
        ...
        <div class="tab-pane fade show" id="menu-property" role="tabpanel">
            <nav class="sidebar-nav">
                <ul class="metismenu">
                    ...
                    <li class="active"><a href="<?php echo site_url('document_storage'); ?>"><i class="fa fa-book"></i><span>Document Storage</span></a></li>
        ...
        <div class="tab-pane fade show" id="menu-report" role="tabpanel">
            <nav class="sidebar-nav">
                <ul class="metismenu">
                    ...
                    <li><a href="<?php echo site_url('incident_report'); ?>"><i class="fa fa-book"></i><span>Incident Report</span></a></li>
