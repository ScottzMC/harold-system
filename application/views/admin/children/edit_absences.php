...
<title>Edit <?php echo $child->fullname; ?> Absences || Admin || Harold</title>
                ...
                <div class="d-flex justify-content-between align-items-center">
                    <div class="header-action">
                        ...
                        <ol class="breadcrumb page-breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Edit <?php echo $child->fullname; ?> Absences</li>
                        </ol>
                    </div>

                    <ul class="nav nav-tabs page-header-tab">
                        <li class="nav-item"><a class="nav-link active show" data-toggle="tab" href="#Absences-edit">Edit <?php echo $child->fullname; ?> Absences</a></li>
                    ...
                    <div class="tab-pane active" id="Absences-edit">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Edit <?php echo $child->fullname; ?> Absences</h3>
                            </div>
                            <?php if(!empty($absences)){ foreach($absences as $abs){} ?>
                            <div class="card-body">
                                <form action="<?php echo base_url('printout_report/edit_absences/'.$abs->id.'/'.$abs->code); ?>" method="post" enctype="multipart/form-data" accept-charset="UTF-8">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                <label>Body</label>
                                                <textarea name="body" class="form-control" aria-label="With textarea"><?php echo $abs->body; ?></textarea>
                                            </div>
                                        </div>
