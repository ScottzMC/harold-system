...
<title>Edit <?php echo $child->fullname; ?> Incidents || Admin || Harold</title>
                ...
                <div class="d-flex justify-content-between align-items-center">
                    <div class="header-action">
                        ...
                        <ol class="breadcrumb page-breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Edit <?php echo $child->fullname; ?> Incidents</li>
                        </ol>
                    </div>
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane active" id="Incidents-edit">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="<?php echo base_url('printout_report/edit_incidents/'.$inc->id.'/'.$inc->code); ?>" method="post" enctype="multipart/form-data" accept-charset="UTF-8">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                <label>Body</label>
                                                <textarea name="body" class="form-control" aria-label="With textarea"><?php echo $inc->body; ?></textarea>
                                            </div>
                                        </div>
