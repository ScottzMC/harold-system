...
<?php foreach($social_worker as $social){} foreach($children as $child){} ?>
<title>Edit <?php echo $child->fullname; ?> Social Worker || Admin || Harold</title>
            ...
            <div class="container-fluid">
                <div class="d-flex justify-content-between align-items-center">
                    <div class="header-action">
                        <h1 class="page-title">Social Worker</h1>
                        <ol class="breadcrumb page-breadcrumb">
                            <li class="breadcrumb-item"><a href="<?php echo site_url('dashboard'); ?>">Dashboard</a></li>
                            <li class="breadcrumb-item"><a href="<?php echo site_url('children'); ?>">Children </a></li>
                            <li class="breadcrumb-item"><a href="<?php echo site_url('children/detail/'.strtolower($child->code)); ?>"><?php echo $social->fullname; ?> Social Worker </a></li>
                            <li class="breadcrumb-item active" aria-current="page">Edit <?php echo $social->fullname; ?> Social Worker</li>
                        </ol>
                    </div>

                    <ul class="nav nav-tabs page-header-tab">
                        <li class="nav-item"><a class="nav-link active show" data-toggle="tab" href="#Incidents-edit">Edit <?php echo $child->fullname; ?> Incidents</a></li>
        ...
        <div class="section-body mt-4">
            <div class="container-fluid">
                <div class="tab-content">
                    ...
                    <div class="tab-pane active" id="Incidents-edit">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="<?php echo base_url('children/edit_social_worker/'.$social->id.'/'.$social->children_code); ?>" method="post" enctype="multipart/form-data" accept-charset="UTF-8">
                                    <div class="row">
                                        <div class="col-md-4 col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="code">
                                                    ...
                                                    <?php foreach($social_worker as $social){ ?>
                                                    <option value="<?php echo $social->children_code; ?>"><?php echo $social->children_code; ?></option>
                                                    <?php } ?>
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-4 col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="fullname" class="form-control" value"<?php echo $social->fullname; ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-4 col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <input type="email" name="email" class="form-control" value"<?php echo $social->email; ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-4 col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="mobile" class="form-control" value"<?php echo $social->mobile; ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                <label>Address</label>
                                                <textarea name="address" class="form-control" aria-label="With textarea"><?php echo $social->address; ?></textarea>
                                            </div>
                                        </div>
