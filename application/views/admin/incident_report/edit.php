...
<?php foreach($incident_report as $incident){} ?>
<title>Edit <?php echo $incident->title; ?> Incident Report || Admin || Harold</title>
                ...
                <div class="d-flex justify-content-between align-items-center">
                    <div class="header-action">
                        ...
                        <ol class="breadcrumb page-breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="<?php echo site_url('incident_report'); ?>">Incident Report </a></li>
                            <li class="breadcrumb-item active" aria-current="page">Edit <?php echo $incident->title; ?> Incident Report</li>
                        </ol>
                    </div>

                    <ul class="nav nav-tabs page-header-tab">
                        <li class="nav-item"><a class="nav-link active show" data-toggle="tab" href="#Incident-edit">Edit <?php echo $incident->title; ?> Incident Report</a></li>
        ...
        <div class="section-body mt-4">
            <div class="container-fluid">
                <div class="tab-content">
                    <div class="tab-pane active" id="Incident-edit">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Edit <?php echo $incident->title; ?> Incident Report</h3>
                            </div>
                            <div class="card-body">
                                <form action="<?php echo base_url('incident_report/edit_incident_report/'.$incident->id); ?>" method="post" enctype="multipart/form-data" accept-charset="UTF-8">
                                    <div class="row">
                                        <div class="col-md-4 col-sm-12">
                                            <div class="form-group">
                                                <label>Title <span class="text-danger">*</span></label>
                                                <input type="text" name="title" class="form-control" value="<?php echo $incident->title; ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                <label>Body</label>
                                                <textarea name="body" class="form-control" aria-label="With textarea"><?php echo $incident->body; ?></textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-4 col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="child_name">
                                                    <option value="<?php echo $incident->child_name; ?>"><?php echo $incident->child_name; ?></option>
