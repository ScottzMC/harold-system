...
<title>Incident Report || Admin || Harold</title>
            ...
            <div class="container-fluid">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <ul class="nav nav-tabs page-header-tab">
                        <li class="nav-item"><a class="nav-link active show" data-toggle="tab" href="#Incident-all">View All Incident Report</a></li>
                        <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#Incident-add">Add Incident Report</a></li>
                    </ul>
                </div>
            </div>
        </div>
        <div class="section-body mt-4">
            <div class="container-fluid">
                <div class="tab-content">
                    ...
                    <!-- Calendar Events -->
                    <div class="tab-pane active" id="Incident-all">
                        <script>
                        function delete_incident_report(id){
                          var del_id = id;
                          if(confirm("Are you sure you want to delete this incident report")){
                          $.post('<?php echo base_url('incident_report/delete_incident_report'); ?>', {"del_id": del_id}, function(data){
                        ...
                        <script>
                            $(function(){
                              $('#downloadable').click(function(){
                                 ...
                                 window.location.href = "<?php echo site_url('sanction_report/download') ?>?file_name="+ $(this).attr('href');
                              });
                            });
                        </script>
                        ...
                        <div class="table-responsive">
                          <table class="table table-hover table-vcenter text-nowrap js-basic-example dataTable table-striped table_custom border-style spacing5">
                                ...
                                <tbody>
                                  <?php if(!empty($incident_report)){ foreach($incident_report as $incident){ ?>
                                    <tr>
                                        <td><?php echo $incident->id; ?></td>
                                        <td><span class="font-16"><?php echo $incident->title; ?></span></td>
                                        <td><?php echo $incident->body; ?></td>
                                        <td><?php echo $incident->child_name; ?></td>
                                        <td><?php echo date('l, dS M Y',strtotime($incident->created_date)); ?></td>
                                        <td><a href="<?php echo site_url('incident_report/edit_incident_report/'.$incident->id); ?>">Edit</a></td>
                                        <td><button type="button" onclick="delete_incident_report(<?php echo $incident->id; ?>)">Delete</button></td>
                                    </tr>
                                  <?php } }else{ echo ''; } ?>
                                </tbody>
                            </table>
                    ...
                    <div class="tab-pane show" id="Incident-add">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Add Incident Reports</h3>
                            </div>
                            <div class="card-body">
                                <form action="<?php echo base_url('incident_report/add_incident_report'); ?>" method="post" enctype="multipart/form-data" accept-charset="UTF-8">
                                    <div class="row">
