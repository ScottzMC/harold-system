...
<title><?php echo $support->title; ?> Support Work || Admin || Harold</title>
                ...
                <div class="d-flex justify-content-between align-items-center">
                    <div class="header-action">
                        ...
                        <ol class="breadcrumb page-breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="<?php echo site_url('support_work'); ?>">Support Work </a></li>
                            <li class="breadcrumb-item active" aria-current="page">Edit <?php echo $support->title; ?> Support Work</li>
                        </ol>
                    </div>

                    <ul class="nav nav-tabs page-header-tab">
                        <li class="nav-item"><a class="nav-link active show" data-toggle="tab" href="#Support-profile">Edit <?php echo $support->title; ?> Support Work</a></li>
        ...
        <div class="section-body mt-4">
            <div class="container-fluid">
                <div class="tab-content">
                    ...
                    <div class="tab-pane active" id="Support-profile">
                        <div class="row">
                            <div class="col-xl-4 col-md-12">
                                <div class="card">
                                    <div class="card-body w_user">
                                        <div class="wid-u-info">
                                            <h5><?php echo $support->title; ?></h5>
                                        </div>
                                    </div>
                                </div>
                                <div class="card">
									...
									<div class="card-body">
										<ul class="list-group">
                                            <li class="list-group-item">
                                                <b>Child's name </b>
                                                <div class="pull-right"><?php echo $support->children; ?></div>
                                            </li>
                                            <li class="list-group-item">
                                                <b>Status </b>
                                                <div class="pull-right"><?php echo $support->status; ?></div>
                                            </li>
                                            <li class="list-group-item">
                                                <b>Uploaded by </b>
                                                <div class="pull-right"><?php echo date('l, dS M Y',strtotime($support->created_date)); ?></div>
                                            </li>
                                            <li class="list-group-item">
                                                <b>Action </b>
                                                <div class="pull-right"><a href="<?php echo site_url('support_work/edit_support_work/'.$support->id); ?>">Edit</a></div>
                                            </li>
                                            <li class="list-group-item">
                                                <b>Action </b>
                                                <div class="pull-right"><a href="<?php echo site_url('support_work/download'); ?>">Download</a></div>
                                            </li>
                                        </ul>
                                    </div>
                            ...
                            <div class="col-xl-8 col-md-12">
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <h3 class="card-title">Covered by the Young person</h3>
                                    </div>
                                    <div class="card-body">
                                        <div class="timeline_item ">
                                            <div class="msg">
                                                <p><?php echo $support->covered_by; ?></p>
                                            </div>                                
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <h3 class="card-title">Understanding the service user</h3>
                                    </div>
                                    <div class="card-body">
                                        <div class="timeline_item ">
                                            <div class="msg">
                                                <p><?php echo $support->understanding_service_user; ?></p>
                                            </div>                                
                                        </div>
                                    </div>
                                </div>
