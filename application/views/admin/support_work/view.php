...
<title>Support Work || Admin || Harold</title>
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane active" id="Support-all">
                        ...
                        function delete_support_work(id){
                          ...
                          $.post('<?php echo base_url('support_work/delete_support_work'); ?>', {"del_id": del_id}, function(data){
                          ...
                          <table class="table table-hover table-vcenter text-nowrap js-basic-example dataTable table-striped table_custom border-style spacing5">
                                <thead>
                                    <tr>
                                        ...
                                        <th>Body</th>
                                        <th>Status</th>
                                        <th>Covered by the Young person</th>
                                        <th>Understanding the service user</th>
                                        <th>Date</th>
                                        <th>Action</th>
                                        <th>Action</th>
                                        <th>Action</th>
                                ...
                                <tbody>
                                  <?php if($support_work){ foreach($support_work as $support){ ?>
                                    <tr>
                                        ...
                                        <td><?php echo $support->children; ?></td>
                                        <td><span class="font-16"><?php echo $support->title; ?></span></td>
                                        <td><?php echo $support->body; ?></td>
                                        <td><?php echo $support->status; ?></td>
                                        <td><?php echo $support->covered_by; ?></td>
                                        <td><?php echo $support->understanding_service_user; ?></td>
                                        <td><?php echo date('l, dS M Y',strtotime($support->created_date)); ?></td>
                                        <td><a href="<?php echo site_url('support_work/detail/'.$support->id); ?>">View</a></td>
                                        <td><a href="<?php echo site_url('support_work/edit_support_work/'.$support->id); ?>">Edit</a></td>
                    ...
                    <div class="tab-pane show" id="Support-add">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="<?php echo base_url('support_work/add_support_work'); ?>" method="post" enctype="multipart/form-data" accept-charset="UTF-8">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <textarea name="covered_by" class="form-control" aria-label="With textarea"></textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <textarea name="understanding_service_user" class="form-control" aria-label="With textarea"></textarea>
                                            </div>
                                        </div>
