                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane active" id="Users-all">
                        ...
                        function delete_user(id){
                          ...
                          $.post('<?php echo base_url('admin/delete_user'); ?>', {"del_id": del_id}, function(data){
                                ...
                                <tbody>
                                  <?php if($users){ foreach($users as $usr){ ?>
                                    <tr>
                                        ...
                                        <!--<td class="w60">
                                            <img class="avatar" src="https://scottnnaghor.com/elimu/uploads/profile/<?php echo $usr->image; ?>" alt="<?php echo $usr->firstname; ?>">
                                        </td>-->
                                        ...
                                        <td><?php echo $usr->address1; ?></td>
                                        <td><?php echo $usr->address2; ?></td>
                                        <td><?php echo $usr->postcode; ?></td>
                                        <td><?php echo $usr->city; ?></td>
                                        <td><?php echo $usr->state; ?></td>
                                        <td><?php echo convertToLoggedFormat($usr->logged_in_time); ?></td>
                                        <td><?php echo date('l, dS M Y',strtotime($usr->logged_in_date)); ?></td>
                                        <td><a href="<?php echo site_url('user/edit_user/'.$usr->id); ?>">Edit</a></td>
