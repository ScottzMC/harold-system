...
<title>Edit <?php echo $usr->firstname; ?> <?php echo $usr->lastname; ?> Users || Admin || Harold</title>
                ...
                <div class="d-flex justify-content-between align-items-center">
                    <div class="header-action">
                        ...
                        <ol class="breadcrumb page-breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Edit <?php echo $usr->firstname; ?> Users</li>
                        </ol>
                    </div>

                    <ul class="nav nav-tabs page-header-tab">
                        <li class="nav-item"><a class="nav-link active show" data-toggle="tab" href="#Users-edit">Edit <?php echo $usr->firstname; ?> Users</a></li>
                    ...
                    <div class="tab-pane active" id="Users-edit">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Edit <?php echo $usr->firstname; ?> <?php echo $usr->lastname; ?> User</h3>
                            </div>
                            <div class="card-body">
                                <form action="<?php echo base_url('user/edit_user/'.$usr->id); ?>" method="post" enctype="multipart/form-data" accept-charset="UTF-8">
                                    <div class="row">
