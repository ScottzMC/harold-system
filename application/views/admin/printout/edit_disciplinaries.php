...
<title>Edit <?php echo $child->fullname; ?> Disciplinaries || Admin || Harold</title>
                ...
                <div class="d-flex justify-content-between align-items-center">
                    <div class="header-action">
                        ...
                        <ol class="breadcrumb page-breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="<?php echo site_url('printout_report/detail/'.strtolower($child->code)); ?>"><?php echo $child->fullname; ?> Printout Report </a></li>
                            <li class="breadcrumb-item active" aria-current="page">Edit <?php echo $child->fullname; ?> Disciplinaries</li>
                        </ol>
                    </div>

                    <ul class="nav nav-tabs page-header-tab">
                        <li class="nav-item"><a class="nav-link active show" data-toggle="tab" href="#Disciplinaries-edit">Edit <?php echo $child->fullname; ?> Disciplinaries</a></li>
        ...
        <div class="section-body mt-4">
            <div class="container-fluid">
                <div class="tab-content">
                    ...
                    <div class="tab-pane active" id="Disciplinaries-edit">
                        
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Edit <?php echo $child->fullname; ?> Disciplinaries</h3>
                            </div>
                            <?php if(!empty($disciplinaries)){ foreach($disciplinaries as $disc){} ?>
                            <div class="card-body">
                                <form action="<?php echo base_url('printout_report/edit_disciplinaries/'.$disc->id.'/'.$disc->code); ?>" method="post" enctype="multipart/form-data" accept-charset="UTF-8">
                                    <div class="row">
