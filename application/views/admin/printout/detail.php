...
<title><?php echo $child->fullname; ?> Children Report Printout || Admin || Harold</title>
            ...
            <div class="container-fluid">
                <div class="d-flex justify-content-between align-items-center">
                    <div class="header-action">
                        <h1 class="page-title">Report Printout</h1>
                        <ol class="breadcrumb page-breadcrumb">
                            <li class="breadcrumb-item"><a href="<?php echo site_url('dashboard'); ?>">Dashboard</a></li>
                            <li class="breadcrumb-item"><a href="<?php echo site_url('printout_report'); ?>">Report Printout </a></li>
                            <li class="breadcrumb-item active" aria-current="page">Edit <?php echo $child->fullname; ?> Report Printout</li>
                        </ol>
                    </div>

                    <ul class="nav nav-tabs page-header-tab">
                        <li class="nav-item"><a class="nav-link active show" data-toggle="tab" href="#Printout-profile">Edit <?php echo $child->fullname; ?> Report Printout</a></li>
        ...
        <div class="section-body mt-4">
            <div class="container-fluid">
                <div class="tab-content">
                    ...
                    <div class="tab-pane active" id="Printout-profile">
                        <div class="row">
                            ...
                            <div class="col-xl-8 col-md-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="timeline_item ">
                                            <span><a href="javascript:void(0);"><?php echo $child->fullname; ?></a> 
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="timeline_item ">
                                            <span>
                                                <a href="javascript:void(0);"><?php echo $child->fullname; ?></a>
                                            </span> 
