...
<title>Edit <?php echo $child->fullname; ?> Sanction Rewards || Admin || Harold</title>
                ...
                <div class="d-flex justify-content-between align-items-center">
                    <div class="header-action">
                        ...
                        <ol class="breadcrumb page-breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Edit <?php echo $child->fullname; ?> Sanction Rewards</li>
                        </ol>
                    </div>

                    <ul class="nav nav-tabs page-header-tab">
                        <li class="nav-item"><a class="nav-link active show" data-toggle="tab" href="#Sanction-edit">Edit <?php echo $child->fullname; ?> Sanction Rewards</a></li>
        ...
        <div class="section-body mt-4">
            <div class="container-fluid">
                <div class="tab-content">
                    ...
                    <div class="tab-pane active" id="Absences-edit">
                        
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Edit <?php echo $child->fullname; ?> Sanction Rewards</h3>
                            </div>
                            <?php if(!empty($sanction)){ foreach($sanction as $sanc){} ?>
                            <div class="card-body">
                                <form action="<?php echo base_url('printout_report/edit_sanction_rewards/'.$sanc->id.'/'.$sanc->code); ?>" method="post" enctype="multipart/form-data" accept-charset="UTF-8">
                                    <div class="row">
                                        <div class="col-md-4 col-sm-12">
                                            <div class="form-group">
                                                <label>Title <span class="text-danger">*</span></label>
                                                <input type="text" name="title" class="form-control" value="<?php echo $sanc->title; ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                <label>Body</label>
                                                <textarea name="body" class="form-control" aria-label="With textarea"><?php echo $sanc->body; ?></textarea>
                                            </div>
                                        </div>
