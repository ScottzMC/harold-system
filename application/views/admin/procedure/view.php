                ...
                <div class="tab-content">
                        ...
                        <script>
                            $(function(){
                              $('#downloadable').click(function(){
                                 ...
                                 window.location.href = "<?php echo site_url('procedure/download') ?>?file_name="+ $(this).attr('href');
                              });
                            });
                        </script>
                                ...
                                <tbody>
                                  <?php if($procedure){ foreach($procedure as $proc){ ?>
                                    <tr>
                                        ...
                                        <td><span class="font-16"><?php echo $proc->title; ?></span></td>
                                        <td><?php echo $proc->body; ?></td>
                                        <td><?php echo convertToProcedureFormat($proc->created_time); ?></td>
                                        <td><?php echo date('l, dS M Y',strtotime($proc->created_date)); ?></td>
                                        <!--<td><a id="downloadable" href="/uploads/procedure/<?php echo $proc->doc; ?>" target="_blank">Download</a></td>-->
                                        <td><a href="<?php echo base_url('procedure/download/'.$proc->id); ?>" target="_blank">Download</a></td>
                                        <td><a href="<?php echo site_url('procedure/edit_procedure/'.$proc->id); ?>">Edit</a></td>
                    ...
                    <div class="tab-pane show" id="Procedure-add">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="<?php echo base_url('procedure/add_procedure'); ?>" method="post" enctype="multipart/form-data" accept-charset="UTF-8">
                                    <div class="row">
