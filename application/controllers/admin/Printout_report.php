<?php 
    ...
    class Printout_report extends CI_Controller{
        ...
        public function index(){
            ...
            if(!empty($session_role) && $session_role == "Admin"){
                ...
                $this->load->view('admin/printout/view', $data);
            }else{
        ...
        public function detail($code){
            ...
            if(!empty($session_role) && $session_role == "Admin"){
                ...
                $this->load->view('admin/printout/detail', $data);
            }else{
                redirect('account/login');    
            }
        }
        ...
        public function add_printout_report(){
            ...
            $insert_printout = $this->Admin_model->insert_children_report($array);
            ...
            if($insert_printout && $insert_medical_history && $insert_personal_education && $insert_finance_information && $insert_disciplinaries && $insert_incidents
            && $insert_absences && $insert_sanction && $insert_abilities && $insert_keywork && $insert_supervision && $insert_case && $insert_health && $insert_visitor){ ?>
                <script>
                    ...
                    window.location.href="<?php echo site_url('printout_report'); ?>";
                </script>
      <?php }else{ ?>
               <script>
                    alert('Failed');
      ...
      <?php }
        ...
        public function edit_printout_report($code){
            ...
            if(!empty($session_role) && $session_role == "Admin"){
                ...
                $this->load->view('admin/printout/edit', $data);
                ...
                if(isset($btn_submit)){
                    ...
                    $update_printout = $this->Admin_model->update_children_report_details($code, $array);
        ...
        public function edit_printout_report_image($code){
              $files = $_FILES;
            ...
            $update_printout_report_image = $this->Admin_model->update_children_report_image($code, $array);
            
            if($update_printout_report_image){ ?>
                <script>
                    alert('Updated Successfully');
                    window.location.href="<?php echo site_url('printout_report'); ?>";
                </script>
      ...
      <?php }
        ...
        public function delete_printout(){
           $id = $this->input->post('del_id');
           $this->Admin_model->delete_children_report($id); 
        }
        
        // End of Printout Report
        ...
        public function edit_disciplinaries($id, $code){
            ...
            if(!empty($session_role) && $session_role == "Admin"){
                ...
                $this->load->view('admin/printout/edit_disciplinaries', $data);
        ...
        public function edit_incidents($id, $code){
            ...
            if(!empty($session_role) && $session_role == "Admin"){
                ...
                $this->load->view('admin/printout/edit_incident', $data);
        ...
        public function edit_absences($id, $code){
            ...
            if(!empty($session_role) && $session_role == "Admin"){
                ...
                $this->load->view('admin/printout/edit_absences', $data);
        ...
        public function edit_sanction_rewards($id, $code){
            ...
            if(!empty($session_role) && $session_role == "Admin"){
                ...
                $this->load->view('admin/printout/edit_sanction_rewards', $data);
        ...
        public function edit_visitor_logs($id, $code){
            ...
            if(!empty($session_role) && $session_role == "Admin"){
                ...
                $this->load->view('admin/printout/edit_visitor_logs', $data);
