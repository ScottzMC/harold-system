<?php 
    ...
    function convertToQualification($timestamp){
...
<title>Qualifications || HR || Harold</title>
            ...
            <div class="container-fluid">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <ul class="nav nav-tabs page-header-tab">
                        <li class="nav-item"><a class="nav-link active show" data-toggle="tab" href="#Qualifications-all">View All Qualifications</a></li>
                        <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#Qualifications-add">Add Qualifications</a></li>
                    </ul>
                </div>
            </div>
        </div>
        <div class="section-body mt-4">
            <div class="container-fluid">
                <div class="tab-content">
                    ...
                    <!-- Calendar Events -->
                    <div class="tab-pane active" id="Qualifications-all">
                        <script>
                        function delete_qualification(id){
                          var del_id = id;
                          if(confirm("Are you sure you want to delete this qualification")){
                          $.post('<?php echo base_url('qualification/delete_qualification'); ?>', {"del_id": del_id}, function(data){
                        ...
                        <script>
                            $(function(){
                              $('#downloadable').click(function(){
                                 ...
                                 window.location.href = "<?php echo site_url('qualification/download') ?>?file_name="+ $(this).attr('href');
                              });
                            });
                        </script>
                        ...
                        <div class="table-responsive">
                          <table class="table table-hover table-vcenter text-nowrap js-basic-example dataTable table-striped table_custom border-style spacing5">
                                ...
                                <tbody>
                                  <?php if($qualification){ foreach($qualification as $qual){ ?>
                                    <tr>
                                        <td><?php echo $qual->id; ?></td>
                                        <td><span class="font-16"><?php echo $qual->title; ?></span></td>
                                        <td><?php echo $qual->body; ?></td>
                                        <td><?php echo convertToQualification($qual->created_time); ?></td>
                                        <td><?php echo date('l, dS M Y',strtotime($qual->created_date)); ?></td>
                                        <td><a href="<?php echo base_url('qualification/download/'.$qual->id); ?>" target="_blank">Download</a></td>
                                        <td><a href="<?php echo site_url('qualification/edit_qualification/'.$qual->id); ?>">Edit</a></td>
                                        <td><button type="button" onclick="delete_qualification(<?php echo $qual->id; ?>)">Delete</button></td>
                                    </tr>
                                  <?php } }else{ echo ''; } ?>
                                </tbody>
                            </table>
                    ...
                    <div class="tab-pane show" id="Qualifications-add">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Add Qualifications</h3>
                            </div>
                            <div class="card-body">
                                <form action="<?php echo base_url('qualification/add_qualification'); ?>" method="post" enctype="multipart/form-data" accept-charset="UTF-8">
                                    <div class="row">
