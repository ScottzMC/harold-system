...
<title>View Staff || Admin || Harold</title>
            ...
            <div class="container-fluid">
                <div class="d-flex justify-content-between align-items-center">
                    <div class="header-action">
                        <h1 class="page-title">View all Staff</h1>
                    ...
                    <ul class="nav nav-tabs page-header-tab">
                        <li class="nav-item"><a class="nav-link active show" data-toggle="tab" href="#Staff-all">View Staff</a></li>
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane active" id="Staff-all">
                        ...
                        function delete_user(id){
                          ...
                          $.post('<?php echo base_url('staff/delete_staff'); ?>', {"del_id": del_id}, function(data){
                        ...
                        <div class="table-responsive">
                          <table class="table table-hover table-vcenter text-nowrap js-basic-example dataTable table-striped table_custom border-style spacing5">
                                ...
                                <tbody>
                                  <?php if($staff){ foreach($staff as $stf){ ?>
                                    <tr>
                                        <td><?php echo $stf->id; ?></td>
                                        <<td class="w60">
                                            <img class="avatar" src="https://scottnnaghor.com/harold/uploads/profile/<?php echo $stf->photo; ?>" alt="<?php echo $stf->firstname; ?>">
                                        </td>
                                        <td><span class="font-16"><?php echo $stf->firstname; ?> <?php echo $stf->lastname; ?></span></td>
                                        <td><?php echo $stf->email; ?></td>
                                        <td><?php echo $stf->role; ?></td>
                                        <td><?php echo $stf->telephone; ?></td>
                                        <td><?php echo $stf->address1; ?></td>
                                        <td><?php echo $stf->address2; ?></td>
                                        <td><?php echo $stf->postcode; ?></td>
                                        <td><?php echo $stf->city; ?></td>
                                        <td><?php echo $stf->state; ?></td>
                                        <td><?php echo convertToLoggedFormat($stf->logged_in_time); ?></td>
                                        <td><?php echo date('l, dS M Y',strtotime($stf->logged_in_date)); ?></td>
                                        <td><a href="<?php echo site_url('staff/edit_staff/'.$stf->id); ?>">Edit</a></td>
                                        <td><button type="button" onclick="delete_staff(<?php echo $stf->id; ?>)">Delete</button></td>
                                    </tr>
                                  <?php } }else{ echo ''; } ?>
                                </tbody>
                            </table>
                    ...
                    <!--<div class="tab-pane show" id="Role-Model-add">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="<?php echo base_url('admin/add_user'); ?>" method="post" enctype="multipart/form-data" accept-charset="UTF-8">
                                    <div class="row">
