...
<?php foreach($legal_document as $legal){} ?>
<title>Edit <?php echo $legal->title; ?> Legal Document || HR || Harold</title>
                ...
                <div class="d-flex justify-content-between align-items-center">
                    <div class="header-action">
                        ...
                        <ol class="breadcrumb page-breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="<?php echo site_url('legal_document'); ?>">Legal Document </a></li>
                            <li class="breadcrumb-item active" aria-current="page">Edit <?php echo $legal->title; ?> Legal Document</li>
                        </ol>
                    </div>

                    <ul class="nav nav-tabs page-header-tab">
                        <li class="nav-item"><a class="nav-link active show" data-toggle="tab" href="#LegalDocument-edit">Edit <?php echo $legal->title; ?> Qualification</a></li>
        ...
        <div class="section-body mt-4">
            <div class="container-fluid">
                <div class="tab-content">
                    <div class="tab-pane active" id="LegalDocument-edit">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Edit <?php echo $legal->title; ?> Legal Document</h3>
                            </div>
                            <div class="card-body">
                                <form action="<?php echo base_url('legal_document/edit_legal_document/'.$legal->id); ?>" method="post" enctype="multipart/form-data" accept-charset="UTF-8">
                                    <div class="row">
                                        <div class="col-md-4 col-sm-12">
                                            <div class="form-group">
                                                <label>Title <span class="text-danger">*</span></label>
                                                <input type="text" name="title" class="form-control" value="<?php echo $legal->title; ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                <label>Body</label>
                                                <textarea name="body" class="form-control" aria-label="With textarea"><?php echo $legal->body; ?></textarea>
                                            </div>
                                        </div>
