<?php 
    ...
    function convertToLegalDocument($timestamp){
...
<title>Legal Documents || HR || Harold</title>
            ...
            <div class="container-fluid">
                <div class="d-flex justify-content-between align-items-center">
                    <div class="header-action">
                        <h1 class="page-title">Legal Document</h1>
                    ...
                    <ul class="nav nav-tabs page-header-tab">
                        <li class="nav-item"><a class="nav-link active show" data-toggle="tab" href="#LegalDocument-all">View All Legal Document</a></li>
                        <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#LegalDocument-add">Add Legal Document</a></li>
                    </ul>
                </div>
            </div>
        </div>
        <div class="section-body mt-4">
            <div class="container-fluid">
                <div class="tab-content">
                    ...
                    <!-- Legal Documents -->
                    <div class="tab-pane active" id="LegalDocument-all">
                        <script>
                        function delete_qualification(id){
                          var del_id = id;
                          if(confirm("Are you sure you want to delete this legal document")){
                          $.post('<?php echo base_url('legal_document/delete_legal_document'); ?>', {"del_id": del_id}, function(data){
                        ...
                        <script>
                            $(function(){
                              $('#downloadable').click(function(){
                                 ...
                                 window.location.href = "<?php echo site_url('legal_document/download') ?>?file_name="+ $(this).attr('href');
                              });
                            });
                        </script>
                        ...
                        <div class="table-responsive">
                          <table class="table table-hover table-vcenter text-nowrap js-basic-example dataTable table-striped table_custom border-style spacing5">
                                ...
                                <tbody>
                                  <?php if($legal_document){ foreach($legal_document as $legal){ ?>
                                    <tr>
                                        <td><?php echo $legal->id; ?></td>
                                        <td><span class="font-16"><?php echo $legal->title; ?></span></td>
                                        <td><?php echo $legal->body; ?></td>
                                        <td><?php echo convertToLegalDocument($legal->created_time); ?></td>
                                        <td><?php echo date('l, dS M Y',strtotime($legal->created_date)); ?></td>
                                        <td><a href="<?php echo base_url('legal_document/download/'.$legal->id); ?>" target="_blank">Download</a></td>
                                        <td><a href="<?php echo site_url('legal_document/edit_legal_document/'.$legal->id); ?>">Edit</a></td>
                                        <td><button type="button" onclick="delete_legal_document(<?php echo $legal->id; ?>)">Delete</button></td>
                                    </tr>
                                  <?php } }else{ echo ''; } ?>
                                </tbody>
                            </table>
                    ...
                    <div class="tab-pane show" id="LegalDocument-add">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Add Legal Documents</h3>
                            </div>
                            <div class="card-body">
                                <form action="<?php echo base_url('legal_document/add_legal_document'); ?>" method="post" enctype="multipart/form-data" accept-charset="UTF-8">
                                    <div class="row">
