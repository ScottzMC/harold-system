        ...
        <div class="tab-pane fade show active" id="menu-hr" role="tabpanel">
            <nav class="sidebar-nav">
                <ul class="metismenu">
                    ...
                    <li class="active"><a href="<?php echo site_url('profile'); ?>"><i class="fa fa-users"></i><span>Profile</span></a></li>
                    ...
                    <li><a href="<?php echo site_url('vehicle_detail'); ?>"><i class="fa fa-car"></i>Vehicle Details</a></li>
