<?php 
    ...
    function convertToDiscipline($timestamp){
...
<title>Discipline || HR || Harold</title>
            ...
            <div class="container-fluid">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <ul class="nav nav-tabs page-header-tab">
                        <li class="nav-item"><a class="nav-link active show" data-toggle="tab" href="#Discipline-all">View All Discipline</a></li>
                        <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#Discipline-add">Add Discipline</a></li>
                    </ul>
                </div>
            </div>
        </div>
        <div class="section-body mt-4">
            <div class="container-fluid">
                <div class="tab-content">
                    ...
                    <!-- Legal Documents -->
                    <div class="tab-pane active" id="Discipline-all">
                        <script>
                        function delete_discipline(id){
                          var del_id = id;
                          if(confirm("Are you sure you want to delete this discipline")){
                          $.post('<?php echo base_url('discipline/delete_discipline'); ?>', {"del_id": del_id}, function(data){
                        ...
                        <div class="table-responsive">
                          <table class="table table-hover table-vcenter text-nowrap js-basic-example dataTable table-striped table_custom border-style spacing5">
                                ...
                                <tbody>
                                  <?php if($discipline){ foreach($discipline as $disc){ ?>
                                    <tr>
                                        <td><?php echo $disc->id; ?></td>
                                        <td><span class="font-16"><?php echo $disc->firstname; ?> <?php echo $disc->lastname; ?></span></td>
                                        <td><span class="font-16"><?php echo $disc->email; ?></span></td>
                                        <td><span class="font-16"><?php echo $disc->title; ?></span></td>
                                        <td><?php echo $disc->body; ?></td>
                                        <td><?php echo convertToDiscipline($disc->created_time); ?></td>
                                        <td><?php echo date('l, dS M Y',strtotime($disc->created_date)); ?></td>
                                        <td><a href="<?php echo site_url('discipline/edit_discipline/'.$disc->id); ?>">Edit</a></td>
                                        <td><button type="button" onclick="delete_discipline(<?php echo $disc->id; ?>)">Delete</button></td>
                                    </tr>
                                  <?php } }else{ echo ''; } ?>
                                </tbody>
                            </table>
                    ...
                    <div class="tab-pane show" id="Discipline-add">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Add Discipline</h3>
                            </div>
                            <div class="card-body">
                                <form action="<?php echo base_url('discipline/add_discipline'); ?>" method="post" enctype="multipart/form-data" accept-charset="UTF-8">
                                    <div class="row">
