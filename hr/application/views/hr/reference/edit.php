...
<title>Edit <?php echo $ref->title; ?> Reference || HR || Harold</title>
                ...
                <div class="d-flex justify-content-between align-items-center">
                    <div class="header-action">
                        ...
                        <ol class="breadcrumb page-breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="<?php echo site_url('reference'); ?>">Reference </a></li>
                            <li class="breadcrumb-item active" aria-current="page">Edit <?php echo $ref->title; ?> Reference</li>
                        </ol>
                    </div>

                    <ul class="nav nav-tabs page-header-tab">
                        <li class="nav-item"><a class="nav-link active show" data-toggle="tab" href="#LegalDocument-edit">Edit <?php echo $ref->title; ?> Reference</a></li>
                    ...
                    <div class="tab-pane active" id="LegalDocument-edit">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Edit <?php echo $ref->title; ?> Reference</h3>
                            </div>
                            <div class="card-body">
                                <form action="<?php echo base_url('reference/edit_reference/'.$ref->id); ?>" method="post" enctype="multipart/form-data" accept-charset="UTF-8">
                                    <div class="row">
                                        <div class="col-md-4 col-sm-12">
                                            <div class="form-group">
                                                <label>Title <span class="text-danger">*</span></label>
                                                <input type="text" name="title" class="form-control" value="<?php echo $ref->title; ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                <label>Body</label>
                                                <textarea name="body" class="form-control" aria-label="With textarea"><?php echo $ref->body; ?></textarea>
                                            </div>
                                        </div>
