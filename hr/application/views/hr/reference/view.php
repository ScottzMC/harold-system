<?php 
    ...
    function convertToReference($timestamp){
...
<title>Reference || HR || Harold</title>
            ...
            <div class="container-fluid">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <ul class="nav nav-tabs page-header-tab">
                        <li class="nav-item"><a class="nav-link active show" data-toggle="tab" href="#Reference-all">View All Reference</a></li>
                        <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#Reference-add">Add Reference</a></li>
                    </ul>
                </div>
            </div>
        </div>
        <div class="section-body mt-4">
            <div class="container-fluid">
                <div class="tab-content">
                    ...
                    <!-- Legal Documents -->
                    <div class="tab-pane active" id="Reference-all">
                        <script>
                        function delete_reference(id){
                          var del_id = id;
                          if(confirm("Are you sure you want to delete this reference")){
                          $.post('<?php echo base_url('reference/delete_reference'); ?>', {"del_id": del_id}, function(data){
                        ...
                        <div class="table-responsive">
                          <table class="table table-hover table-vcenter text-nowrap js-basic-example dataTable table-striped table_custom border-style spacing5">
                                ...
                                <tbody>
                                  <?php if($reference){ foreach($reference as $ref){ ?>
                                    <tr>
                                        <td><?php echo $ref->id; ?></td>
                                        <td><span class="font-16"><?php echo $ref->title; ?></span></td>
                                        <td><?php echo $ref->body; ?></td>
                                        <td><?php echo convertToReference($ref->created_time); ?></td>
                                        <td><?php echo date('l, dS M Y',strtotime($ref->created_date)); ?></td>
                                        <td><a href="<?php echo site_url('reference/edit_reference/'.$ref->id); ?>">Edit</a></td>
                                        <td><button type="button" onclick="delete_reference(<?php echo $ref->id; ?>)">Delete</button></td>
                                    </tr>
                                  <?php } }else{ echo ''; } ?>
                                </tbody>
                            </table>
                    ...
                    <div class="tab-pane show" id="Reference-add">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Add Reference</h3>
                            </div>
                            <div class="card-body">
                                <form action="<?php echo base_url('reference/add_reference'); ?>" method="post" enctype="multipart/form-data" accept-charset="UTF-8">
                                    <div class="row">
