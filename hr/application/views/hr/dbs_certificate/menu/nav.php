...
<div id="left-sidebar" class="sidebar">
    ...
    <ul class="nav nav-tabs">
        <li class="nav-item"><a class="nav-link active" data-toggle="tab" href="#menu-hr">HR</a></li>
    </ul>
        ...
        <div class="tab-pane fade show active" id="menu-hr" role="tabpanel">
            <nav class="sidebar-nav">
                <ul class="metismenu">
                    ...
                    <li class="active"><a href="<?php echo site_url('dbs_certificate'); ?>"><i class="fa fa-book"></i><span>DBS Certificate</span></a></li>
