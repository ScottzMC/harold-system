<?php 
    ...
    function convertToDbs($timestamp){
...
<title>DBS Certificate || HR || Harold</title>
            ...
            <div class="container-fluid">
                <div class="d-flex justify-content-between align-items-center">
                    <div class="header-action">
                        <h1 class="page-title">DBS Certificate</h1>
                        <ol class="breadcrumb page-breadcrumb">
                          <li class="breadcrumb-item"><a href="<?php echo site_url('dashboard'); ?>">Dashboard</a></li>
                            <li class="breadcrumb-item active" aria-current="page">DBS Certificate</li>
                        </ol>
                    </div>

                    <ul class="nav nav-tabs page-header-tab">
                        <li class="nav-item"><a class="nav-link active show" data-toggle="tab" href="#DBS-all">View All DBS Certificate</a></li>
                        <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#DBS-add">Add DBS Certificate</a></li>
                    </ul>
                </div>
            </div>
        </div>
        <div class="section-body mt-4">
            <div class="container-fluid">
                <div class="tab-content">
                    ...
                    <!-- Legal Documents -->
                    <div class="tab-pane active" id="DBS-all">
                        <script>
                        function delete_dbs_certificate(id){
                          var del_id = id;
                          if(confirm("Are you sure you want to delete this dbs certificate")){
                          $.post('<?php echo base_url('dbs_certificate/delete_dbs_certificate'); ?>', {"del_id": del_id}, function(data){
                        ...
                        <script>
                            $(function(){
                              $('#downloadable').click(function(){
                                 ...
                                 window.location.href = "<?php echo site_url('dbs_certificate/download') ?>?file_name="+ $(this).attr('href');
                              });
                            });
                        </script>
                        ...
                        <div class="table-responsive">
                          <table class="table table-hover table-vcenter text-nowrap js-basic-example dataTable table-striped table_custom border-style spacing5">
                                ...
                                <tbody>
                                  <?php if($dbs_certificate){ foreach($dbs_certificate as $dbs){ ?>
                                    <tr>
                                        <td><?php echo $dbs->id; ?></td>
                                        <td><span class="font-16"><?php echo $dbs->title; ?></span></td>
                                        <td><?php echo $dbs->body; ?></td>
                                        <td><?php echo convertToDbs($dbs->created_time); ?></td>
                                        <td><?php echo date('l, dS M Y',strtotime($dbs->created_date)); ?></td>
                                        <td><a href="<?php echo base_url('dbs_certificate/download/'.$dbs->id); ?>" target="_blank">Download</a></td>
                                        <td><a href="<?php echo site_url('dbs_certificate/edit_dbs_certificate/'.$dbs->id); ?>">Edit</a></td>
                                        <td><button type="button" onclick="delete_dbs_certificate(<?php echo $dbs->id; ?>)">Delete</button></td>
                                    </tr>
                                  <?php } }else{ echo ''; } ?>
                                </tbody>
                            </table>
                    ...
                    <div class="tab-pane show" id="DBS-add">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Add DBS Certificate</h3>
                            </div>
                            <div class="card-body">
                                <form action="<?php echo base_url('dbs_certificate/add_dbs_certificate'); ?>" method="post" enctype="multipart/form-data" accept-charset="UTF-8">
                                    <div class="row">
