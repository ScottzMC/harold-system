<?php 
    ...
    function convertToVehicle($timestamp){
...
<title>Vehicle Detail || HR || Harold</title>
            ...
            <div class="container-fluid">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <ul class="nav nav-tabs page-header-tab">
                        <li class="nav-item"><a class="nav-link active show" data-toggle="tab" href="#Vehicle-all">View All Vehicle Detail</a></li>
                        <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#Vehicle-add">Add Vehicle Detail</a></li>
                    </ul>
                </div>
            </div>
        </div>
        <div class="section-body mt-4">
            <div class="container-fluid">
                <div class="tab-content">
                    ...
                    <!-- Legal Documents -->
                    <div class="tab-pane active" id="Vehicle-all">
                        <script>
                        function delete_vehicle_detail(id){
                          var del_id = id;
                          if(confirm("Are you sure you want to delete this vehicle")){
                          $.post('<?php echo base_url('vehicle_detail/delete_vehicle_detail'); ?>', {"del_id": del_id}, function(data){
                        ...
                        <div class="table-responsive">
                          <table class="table table-hover table-vcenter text-nowrap js-basic-example dataTable table-striped table_custom border-style spacing5">
                                ...
                                <tbody>
                                  <?php if($vehicle){ foreach($vehicle as $veh){ ?>
                                    <tr>
                                        <td><?php echo $veh->id; ?></td>
                                        <td><span class="font-16"><?php echo $veh->vehicle_owner; ?></span></td>
                                        <td><span class="font-16"><?php echo $veh->vehicle; ?></span></td>
                                        <td><span class="font-16"><?php echo $veh->vehicle_model; ?></span></td>
                                        <td><span class="font-16"><?php echo $veh->vehicle_number; ?></span></td>
                                        <td><span class="font-16"><?php echo $veh->insurance; ?></span></td>
                                        <td><?php echo convertToVehicle($veh->created_time); ?></td>
                                        <td><?php echo date('l, dS M Y',strtotime($veh->created_date)); ?></td>
                                        <td><a href="<?php echo site_url('vehicle_detail/edit_vehicle_detail/'.$veh->id); ?>">Edit</a></td>
                                        <td><button type="button" onclick="delete_vehicle_detail(<?php echo $veh->id; ?>)">Delete</button></td>
                                    </tr>
                                  <?php } }else{ echo ''; } ?>
                                </tbody>
                            </table>
                    ...
                    <div class="tab-pane show" id="Vehicle-add">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Add Vehicle Detail</h3>
                            </div>
                            <div class="card-body">
                                <form action="<?php echo base_url('vehicle_detail/add_vehicle_detail'); ?>" method="post" enctype="multipart/form-data" accept-charset="UTF-8">
                                    <div class="row">
                                        <div class="col-md-4 col-sm-12">
                                            <div class="form-group">
                                                <label>Vehicle Owner <span class="text-danger">*</span></label>
                                                <input type="text" name="vehicle_owner" class="form-control" value="">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-4 col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="vehicle_model" class="form-control" value="">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-4 col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="vehicle_number" class="form-control" value="">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <textarea name="insurance" class="form-control" aria-label="With textarea"></textarea>
                                            </div>
                                        </div>
